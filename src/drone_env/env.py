...
class DroneEnv(gym.Env):
    ...
    def render(self):
        ...
        # Update statt Clear für Performance
        ...
        if first_render:
            ...
            self._render_objects['drone_circle_top'].center = (self.position[0], self.position[1])
        ...
        if first_render:
            ...
            self._render_objects['drone_circle_front'].center = (self.position[0], self.position[2])
        ...
        if first_render:
            ...
            # Update Positionen
            self._render_objects['target_circle_top'].center = (self.target_position[0], self.target_position[1])
        ...
        if first_render:
            ...
            # Update Positionen
            self._render_objects['target_circle_front'].center = (self.target_position[0], self.target_position[2])
        ...
        wind_mag_full = np.linalg.norm(self.wind_vector)
        ...
        if self.render_mode == "human":
            ...
            # Verwende buffer_rgba() statt veraltetes tostring_rgb()
